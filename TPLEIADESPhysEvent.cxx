...
void TPLEIADESDetPhysics::Clear(Option_t *opt)
{
    ...
    fpFPGAEnergy = fpBIBOXEnergy = fpTraceIntEnergy = fpExpFitIntEnergy = fpBaselineVal = -99;
    fnFPGAEnergy = fnBIBOXEnergy = fnTraceIntEnergy = fnExpFitIntEnergy = fnBaselineVal = -99;
