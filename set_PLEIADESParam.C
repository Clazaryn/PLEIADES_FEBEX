...
void set_PLEIADESParam()
{
    ...
    //param0->fBoardID[1][4] = 0x14; NO longer used in optimised setup (CJG 25/03/2025)
    ...
    param0->fnSideMap[s1name] = 0x130;      // slot 1 n-side goes to card 3, ch 0
    //----- Slot 2 -----
    TString s2name = "slot2_DSSD_SFP1"; //DSSD_C161054";
    ...
    param0->fDSSDMap[s2name][0] = 0x138;            // pin1 goes to card 3, ch 8
    param0->fDSSDMap[s2name][1] = 0x139;            // pin2 goes to card 3, ch 9
    param0->fDSSDMap[s2name][2] = 0x13A;            // pin6 goes to card 3, ch 10
    param0->fDSSDMap[s2name][3] = 0x13B;            // pin7 goes to card 3, ch 11
    //----- Slot 3 -----
    ...
    param0->fnSideMap[s3name] = 0x131;      // slot 3 n-side goes to card 3, ch 1
    //----- Slot 4 -----
    ...
    param0->fnSideMap[s4name] = 0x132;      // slot 4 n-side goes to card 3, ch 2
    //----- Slot 5 -----
    ...
    param0->fpSideMap[s5name] = 0x120;      // slot 5 p-side goes to card 2, ch 0-6 (WEIRD don't ask me)
    param0->fnSideMap[s5name] = 0x133;      // slot 5 n-side goes to card 3, ch 3
    //----- Slot 6 -----
    ...
    param0->fnSideMap[s6name] = 0x134;      // slot 6 n-side goes to card 3, ch 4
    //----- Slot 7 -----
    /*EMPTY SLOT!!!    TString s7name = "slot7_MSPad_16C";
    ...
    param0->fnSideMap[s7name] = 0x135;      // slot 7 n-side goes to card 3, ch 5
    */
    //----- Slot 8 -----
    TString s8name = "slot8_MSPad_16C";
    param0->fDetNameVec.push_back(s8name);  // add detector to named list
    param0->fDetTypeMap[s8name] = "SiPad";  // define detector type
    param0->fpSideMap[s8name] = 0x128;      // slot 8 p-side goes to card 2, ch 8-15
    param0->fnSideMap[s8name] = 0x135;      // slot 8 n-side goes to card 3, ch 6
    //----- Slot 9 -----
    ...
    param0->fpSideMap[s9name] = 0x128;      // slot 8 p-side goes to card 3, ch 8-15
    param0->fnSideMap[s9name] = 0x137;      // slot 9 n-side goes to card 3, ch 7
    */
    //----- Slot BP -----
    ...
    param0->fCrystalMap[sBPname][0] = 0x13E;         // BP pin1 goes to card 3, ch 12
    param0->fCrystalMap[sBPname][1] = 0x13F;         // BP pin2 goes to card 3, ch 13
